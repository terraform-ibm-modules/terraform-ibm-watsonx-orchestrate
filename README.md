...
[![Terraform Registry](https://img.shields.io/badge/terraform-registry-623CE4?logo=terraform)](https://registry.terraform.io/modules/terraform-ibm-modules/watsonx-orchestrate/ibm/latest)
...
## Overview
<ul>
  <li><a href="#terraform-ibm-watsonx-orchestrate">terraform-ibm-watsonx-orchestrate</a></li>
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-watsonx-orchestrate/tree/main/examples">Examples</a>
    <ul>
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-watsonx-orchestrate/tree/main/examples/basic">Basic example</a>
        <a href="https://cloud.ibm.com/schematics/workspaces/create?workspace_name=watsonx-orchestrate-basic-example&repository=https://github.com/terraform-ibm-modules/terraform-ibm-watsonx-orchestrate/tree/main/examples/basic"><img src="https://img.shields.io/badge/Deploy%20with%20IBM%20Cloud%20Schematics-0f62fe?style=flat&logo=ibm&logoColor=white&labelColor=0f62fe" alt="Deploy with IBM Cloud Schematics" style="height: 16px; vertical-align: text-bottom; margin-left: 5px;"></a>
      </li>
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-watsonx-orchestrate/tree/main/examples/existing-instance">Existing instance example</a>
        <a href="https://cloud.ibm.com/schematics/workspaces/create?workspace_name=watsonx-orchestrate-existing-instance-example&repository=https://github.com/terraform-ibm-modules/terraform-ibm-watsonx-orchestrate/tree/main/examples/existing-instance"><img src="https://img.shields.io/badge/Deploy%20with%20IBM%20Cloud%20Schematics-0f62fe?style=flat&logo=ibm&logoColor=white&labelColor=0f62fe" alt="Deploy with IBM Cloud Schematics" style="height: 16px; vertical-align: text-bottom; margin-left: 5px;"></a>
      </li>
    </ul>
    ℹ️ Ctrl/Cmd+Click or right-click on the Schematics deploy button to open in a new tab.
  </li>
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-watsonx-orchestrate/tree/main/solutions">Deployable Architectures</a>
    <ul>
      <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-watsonx-orchestrate/tree/main/solutions/fully-configurable">Cloud automation for watsonx Orchestrate (Fully configurable)</a></li>
    </ul>
  </li>
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_crn_parser"></a> [crn\_parser](#module\_crn\_parser) | terraform-ibm-modules/common-utilities/ibm//modules/crn-parser | 1.8.0 |
...
| <a name="input_resource_tags"></a> [resource\_tags](#input\_resource\_tags) | Add user resource tags to the watsonx Orchestrate instance to organize, track, and manage costs. [Learn more](https://cloud.ibm.com/docs/account?topic=account-tag&interface=ui#tag-types). | `list(string)` | `[]` | no |
