...
variable "region" {
  ...
  validation {
    ...
    error_message = "Region must be specified and set to one of the possible values ('us-south', 'ca-tor', 'eu-gb', 'eu-de', 'au-syd', 'br-sao' , 'jp-tok') when an instance is provisioned."
  }
}
